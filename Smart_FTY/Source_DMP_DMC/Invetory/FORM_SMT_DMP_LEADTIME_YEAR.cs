...
namespace Smart_FTY
{
    public partial class FORM_SMT_DMP_LEADTIME_YEAR : Form
    {
        public FORM_SMT_DMP_LEADTIME_YEAR()
        {
            InitializeComponent();
        ...
        {
            Form fc = Application.OpenForms["FORM_SMT_DMP_LEADTIME_WEEK"];
            if (fc != null)
            {
            ...
            {
                FORM_SMT_DMP_LEADTIME_WEEK f = new FORM_SMT_DMP_LEADTIME_WEEK();
                f.Show();
                this.Hide();
            }
        }
