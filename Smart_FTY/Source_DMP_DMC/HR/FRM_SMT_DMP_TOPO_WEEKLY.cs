...
namespace Smart_FTY
{
    public partial class FRM_SMT_DMP_TOPO_WEEKLY : Form
    {
        public FRM_SMT_DMP_TOPO_WEEKLY()
        {
            InitializeComponent();
        }
        ...
        void DWMYClick(string ButtonCap, string ButtonCD)
        {
            ...
            switch (ButtonCD)
            {
                ...
                case "W":
                    this.Hide();
                    Form fc1 = Application.OpenForms["FRM_SMT_DMP_TOPO_WEEKLY"];
                    if (fc1 != null)
                        fc1.Show();
                    else
                    {
        ...
        private void BindingData(string arg_op)
        {
            try
            {
                ...
                dtsource = SEL_OS_TOPO_WEEKLY("Q_T", arg_op);
