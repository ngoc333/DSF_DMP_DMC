...
namespace Smart_FTY
{
    public partial class FORM_DMP_DEFFECTIVE_STATUS_YEAR: Form
    {
        #region Declare
        int iNumRow = 0;
       ...
       // int _time = 0;
        ...
        #region Creation
        public FORM_DMP_DEFFECTIVE_STATUS_YEAR(int arg_idx = 0)
        {
            InitializeComponent();
            idx_form = arg_idx;
        }
        ...
        private DataTable select_deffect_monitor(string sYear)
        {
            ...
            MyOraDB.Process_Name = "pkg_DMC.SEL_DEFFECT_MONITOR_YEAR";
        ...
        private DataTable select_chart_1(string arg_year)
        {
            ...
            COM.OraDB MyOraDB = new COM.OraDB();
            MyOraDB.ReDim_Parameter(2);
            MyOraDB.Process_Name = "pkg_DMC.sel_chart_1_year";
        ...
        #region Event
        private void FORM_DMP_DEFFECTIVE_STATUS_YEAR_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void FORM_DMP_DEFFECTIVE_STATUS_YEAR_VisibleChanged(object sender, EventArgs e)
        {
            if (this.Visible)
            {
                //try
