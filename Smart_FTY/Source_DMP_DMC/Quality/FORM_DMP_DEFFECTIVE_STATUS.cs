    ...
    public partial class FORM_DMP_DEFFECTIVE_STATUS: Form
    {
       ...
       // int _time = 0;
        ...
        private DataTable select_deffect_monitor(string arg_month)
        {
            ...
            MyOraDB.Process_Name = "MES.PKG_SMT_DMP_DMC.SEL_DEFFECT_MONITOR_V2";
        ...
        private DataTable select_chart_1(string arg_month)
        {
            ...
            COM.OraDB MyOraDB = new COM.OraDB();
            MyOraDB.ReDim_Parameter(2);
            MyOraDB.Process_Name = "MES.PKG_SMT_DMP_DMC.SEL_CHART_1_V2";
        ...
        {
            Smart_FTY.ComVar._frmdefectiveyear.Show();
            this.Hide();
        }
