...
namespace Smart_FTY
{
    public partial class FORM_DMP_KPI_PERFOMANCE : Form
    {
        ...
        public FORM_DMP_KPI_PERFOMANCE()
        {
            InitializeComponent();
        }
        ...
        private void setImage(Button arg_cmd)
        {
            ...
            {
                arg_cmd.BackgroundImage = Smart_FTY.Properties.Resources.up;
            }
            else
            {
                arg_cmd.BackgroundImage = Smart_FTY.Properties.Resources.down;
            }
        ...
        public void createChart(WinChartViewer viewer, double[] data, string img)
        {
           ...
           // string[] labels = _strLabel;
            ...
            c.setPlotArea(70, 50, c.getWidth() - 110, c.getHeight() - 100, 0xf4f4f4,
        ...
        private void load_grid(AxFPSpreadADO.AxfpSpread axGrid)
        {
            ...
            axGrid.SetCellBorder(1, 1, axGrid.MaxCols, axGrid.MaxRows, CellBorderIndexConstants.CellBorderIndexLeft, 0, CellBorderStyleConstants.CellBorderStyleSolid);
            axGrid.SetCellBorder(1, 2, axGrid.MaxCols, axGrid.MaxRows, CellBorderIndexConstants.CellBorderIndexBottom, 0, CellBorderStyleConstants.CellBorderStyleSolid);
            axGrid.SetCellBorder(1, 2, axGrid.MaxCols, axGrid.MaxRows, CellBorderIndexConstants.CellBorderIndexTop, 0, CellBorderStyleConstants.CellBorderStyleSolid);
        ...
        private DataTable SELECT_KPI_PER()
        {
            ...
            try
            {
                string process_name = "SEPHIROTH.PKG_DMC.SELECT_KPI_PER";
                //ARGMODE
        ...
        private void cmd_C6_Click(object sender, EventArgs e)
        {

        }

        private void axGrid_C4_Advance(object sender, AxFPSpreadADO._DSpreadEvents_AdvanceEvent e)
        {
