...
namespace Smart_FTY
{
    ...
    public partial class FORM_SMT_DMP_DMC_MOLD_ACTUAL_PLAN : Form
    {
        public FORM_SMT_DMP_DMC_MOLD_ACTUAL_PLAN()
        {
            InitializeComponent();
            CheckForIllegalCrossThreadCalls = false;
        }
        public FORM_SMT_DMP_DMC_MOLD_ACTUAL_PLAN(string _process)
        {
            InitializeComponent();
            CheckForIllegalCrossThreadCalls = false;
            _status = _process;
            if (_process == "DMC")
            {
                lblTitle.Text = "DMC APS Plan && Actual";
            ...
            if (_process == "DMP")
            {
                lblTitle.Text = "DMP APS Plan && Actual";
      ...
      //  Thread th;
        ...
        private void lblButton1_Click(object sender, EventArgs e)
        {
            ...
            Smart_FTY.ComVar._frmPro_MoldActualPlanDMC.Show();
            this.Hide();
