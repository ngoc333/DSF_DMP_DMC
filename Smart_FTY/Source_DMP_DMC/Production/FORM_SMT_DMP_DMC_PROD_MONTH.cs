...
namespace Smart_FTY
{
    public partial class FORM_SMT_DMP_DMC_PROD_MONTH : SampleFrm2
    {
        public FORM_SMT_DMP_DMC_PROD_MONTH()
        {
            InitializeComponent();
            lblTitle.Text = "DMC Production Status by Month";
        ...
        private void FORM_SMT_DMP_DMC_PROD_MONTH_Load(object sender, EventArgs e)
        {
        ...
        public DataTable SEL_OS_PROD_MONTH(string ARG_QTYPE, string ARG_OP)
        {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_DMP_DMC.SP_DMP_DMC_PROD_MONTH";
        ...
        private void lblEVA_Click(object sender, EventArgs e)
        {
            ...
            lblTitle.Text = "DMP Production Status by Month";
            _sProcess = "DMP";
        ...
        private void FORM_SMT_DMP_DMC_PROD_MONTH_VisibleChanged(object sender, EventArgs e)
        {
