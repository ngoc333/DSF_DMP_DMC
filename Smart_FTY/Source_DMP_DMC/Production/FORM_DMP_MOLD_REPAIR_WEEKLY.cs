    ...
    public partial class FORM_DMP_MOLD_REPAIR_WEEKLY : Form
    {
     ...
     //   bool _IsKey = true;
        ...
        private void InitGrid(DataTable source)
        {
            ...
            axfpHeaderData.TypeHAlign = TypeHAlignConstants.TypeHAlignCenter;
            axfpHeaderData.TypeVAlign = TypeVAlignConstants.TypeVAlignCenter;
            ...
            axfpHeaderData.ScrollBars = ScrollBarsConstants.ScrollBarsVertical;
            ...
            axfpHeaderData.SetCellBorder(1, 1, numCols, numRows, CellBorderIndexConstants.CellBorderIndexLeft, 0xFFCCAC, CellBorderStyleConstants.CellBorderStyleSolid);
            axfpHeaderData.SetCellBorder(1, 1, numCols, numRows, CellBorderIndexConstants.CellBorderIndexRight, 0xFFCCAC, CellBorderStyleConstants.CellBorderStyleSolid);
            axfpHeaderData.SetCellBorder(1, 1, numCols, numRows, CellBorderIndexConstants.CellBorderIndexTop, 0xFFCCAC, CellBorderStyleConstants.CellBorderStyleSolid);
            axfpHeaderData.SetCellBorder(1, 1, numCols, numRows, CellBorderIndexConstants.CellBorderIndexBottom, 0xFFCCAC, CellBorderStyleConstants.CellBorderStyleSolid);
        ...
        private void Init_Head_Grid(double[] w_row, int h_row, string[] text, Color back, Color fore)
        {
            ...
            axfpHeaderData.ScrollBars = ScrollBarsConstants.ScrollBarsVertical;
            //axfpHeaderData.ScrollBarWidth = 50;
            axfpHeaderData.ScrollBars = ScrollBarsConstants.ScrollBarsNone;
            axfpHeaderData.ActiveCellHighlightStyle = ActiveCellHighlightStyleConstants.ActiveCellHighlightStyleOff;
            ...
            axfpHeaderData.SetCellBorder(1, 1, w_row.Length - 1, 1, CellBorderIndexConstants.CellBorderIndexRight, 0, CellBorderStyleConstants.CellBorderStyleSolid);
        ...
        private void Init_Head_Grid_Clean_Status(double[] w_row, int h_row, string[] text, string[] text1, Color back, Color fore, Color back1, Color fore1)
        {
            ...
            axfpHeaderData.TypeEditMultiLine = true;
            axfpHeaderData.SetCellBorder(1, 1, w_row.Length - 1, 1, CellBorderIndexConstants.CellBorderIndexRight, 0, CellBorderStyleConstants.CellBorderStyleSolid);
            axfpHeaderData.SetCellBorder(1, 1, w_row.Length - 1, 1, CellBorderIndexConstants.CellBorderIndexBottom, 0, CellBorderStyleConstants.CellBorderStyleSolid);
            axfpHeaderData.SetCellBorder(1, 2, w_row.Length - 1, 2, CellBorderIndexConstants.CellBorderIndexRight, 0, CellBorderStyleConstants.CellBorderStyleSolid);
        ...
        private void Add_data_clean(int arg_col, int arg_row, string arg_text, string arg_align)
        {
            ...
            if (arg_align == "L")
                axfpHeaderData.TypeHAlign = TypeHAlignConstants.TypeHAlignLeft;
            else if (arg_align == "C")
                axfpHeaderData.TypeHAlign = TypeHAlignConstants.TypeHAlignCenter;
            else
                axfpHeaderData.TypeHAlign = TypeHAlignConstants.TypeHAlignRight;
            ...
            for (int i = 0; i < source.Rows.Count; i++)
            {
                ...
                for (int j = 0; j < 7; j++)
                {
                    if (j == 4 || j == 5 || j == 6)
                    {
                        ...
                        axfpHeaderData.CellType = CellTypeConstants.CellTypeStaticText;
                        axfpHeaderData.TypeHAlign = TypeHAlignConstants.TypeHAlignRight;
                        axfpHeaderData.TypeVAlign = TypeVAlignConstants.TypeVAlignCenter;
        ...
        private void SetGrid()
        {
            ...
            //axGrid.SetCellBorder(DayOfMonth + 3, 1, DayOfMonth + 3, 10, CellBorderIndexConstants.CellBorderIndexBottom, 0, CellBorderStyleConstants.CellBorderStyleSolid);

            //for (int i = 2; i <= 10; i++)
            //{
            //    axGrid.Row = i;
            //    axGrid.CellType = CellTypeConstants.CellTypeNumber;
        ...
        private void LoadDataToGrid(DataTable source)
        {
            try
            {
               ...
               // col_size = 20;
                ...
                axfpHeaderData.BackColor = Color.DeepSkyBlue;
                axfpHeaderData.ForeColor = Color.White;
                axfpHeaderData.CellType = CellTypeConstants.CellTypeEdit;
                axfpHeaderData.TypeEditMultiLine = true;
                axfpHeaderData.TypeHAlign = TypeHAlignConstants.TypeHAlignCenter;
                axfpHeaderData.TypeVAlign = TypeVAlignConstants.TypeVAlignCenter;
                ...
                axfpHeaderData.SetCellBorder(1, 1, numCols, 2, CellBorderIndexConstants.CellBorderIndexLeft, 0, CellBorderStyleConstants.CellBorderStyleBlank);
                axfpHeaderData.SetCellBorder(1, 1, numCols, 2, CellBorderIndexConstants.CellBorderIndexRight, 0, CellBorderStyleConstants.CellBorderStyleBlank);
                axfpHeaderData.SetCellBorder(1, 1, numCols, 2, CellBorderIndexConstants.CellBorderIndexTop, 0, CellBorderStyleConstants.CellBorderStyleBlank);
                axfpHeaderData.SetCellBorder(1, 1, numCols, 2, CellBorderIndexConstants.CellBorderIndexBottom, 0, CellBorderStyleConstants.CellBorderStyleBlank);
        ...
        private void LoadDataToGridModel(DataTable source)
        {
            try
            {
                ...
                axGridModel.ScrollBars = ScrollBarsConstants.ScrollBarsNone;
                for (int i = 1; i <= numCols; i++)
                {
                ...
                axGridModel.CellType = CellTypeConstants.CellTypeEdit;
                axGridModel.TypeEditMultiLine = true;
                axGridModel.TypeHAlign = TypeHAlignConstants.TypeHAlignCenter;
                axGridModel.TypeVAlign = TypeVAlignConstants.TypeVAlignCenter;
                axGridModel.Font = new System.Drawing.Font("Calibri", 12, FontStyle.Bold);
                axGridModel.ActiveCellHighlightStyle = ActiveCellHighlightStyleConstants.ActiveCellHighlightStyleOff;
                axGridModel.BackColor = Color.Gray;
                axGridModel.ForeColor = Color.White;

                axGridModel.SetCellBorder(1, 1, numCols, 1, CellBorderIndexConstants.CellBorderIndexLeft, 0, CellBorderStyleConstants.CellBorderStyleBlank);
                axGridModel.SetCellBorder(1, 1, numCols, 1, CellBorderIndexConstants.CellBorderIndexRight, 0, CellBorderStyleConstants.CellBorderStyleBlank);
                axGridModel.SetCellBorder(1, 1, numCols, 1, CellBorderIndexConstants.CellBorderIndexTop, 0, CellBorderStyleConstants.CellBorderStyleBlank);
                axGridModel.SetCellBorder(1, 1, numCols, 1, CellBorderIndexConstants.CellBorderIndexBottom, 0, CellBorderStyleConstants.CellBorderStyleBlank);
            ...
            try
            {
                ...
                switch (_frm)
                {
                    ...
                    case 3:
                        ...
                        lbl_header.Text = "DMC && DMP Mold Overhaul by Week (" + DateTime.Now.AddDays(-7).ToString("MMM-dd") + " ~ " + DateTime.Now.ToString("MMM-dd") + ")";
                        viewMode = "WEEKLY";
                        axfpHeaderData.Hide();
                        ////  pn_header_clean.Visible = false;
                        ////axfpHeaderData.Visible = true;
