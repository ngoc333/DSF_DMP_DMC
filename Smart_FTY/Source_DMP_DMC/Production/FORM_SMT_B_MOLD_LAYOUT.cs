...
namespace Smart_FTY
{
    ...
    public partial class FORM_SMT_B_MOLD_LAYOUT : Form_Parent
    {
      ...
      //  Thread th;
        ...
        private void create_default()
        {
            try
            {
               ...
               // }
                ...
                //if (_status=="PH3")
                //    axGrid.ScrollBars = ScrollBarsConstants.ScrollBarsVertical;
                //else
        ...
        private void SetModelCMP(int arg_icol, int arg_irow, string arg_text, AxfpSpread arg_grid)
        {
            if (arg_icol == 2)
            ...
            arg_grid.TypeHAlign = TypeHAlignConstants.TypeHAlignRight;
            arg_grid.TypeTextOrient = TypeTextOrientConstants.TypeTextOrientUp;
        ...
        #region DMC
        private void DisplayGrid(DataTable arg_dt, AxfpSpread arg_grid)
        {
            create_default();
            _Loc_plan_DMP.Clear();
           // Form_Main.headText = "";
        ...
        private void MachineHead(int arg_icol, int arg_irow, int arg_idt, DataTable arg_dt, AxfpSpread arg_grid)
        {
            try
            {
        ...
        public void MachineBody(int arg_icol, int arg_irow, int arg_idt, DataTable arg_dt, AxfpSpread arg_grid)
        {
            try
            {
                arg_grid.SetCellBorder(arg_icol, arg_irow, arg_icol + 1, arg_irow, CellBorderIndexConstants.CellBorderIndexLeft, 0, CellBorderStyleConstants.CellBorderStyleSolid);
                ...
                arg_grid.SetCellBorder(arg_icol, arg_irow, arg_icol + 1, arg_irow, CellBorderIndexConstants.CellBorderIndexBottom, 0, CellBorderStyleConstants.CellBorderStyleSolid);
                ...
                {
                    arg_grid.BackColor = Color.FromArgb(191, 191, 191);
                    //for (int ic = 2; ic <= 150; ic++)
                    //    arg_grid.set_ColWidth(ic, 10.2);
        ...
        private void MachineCenter(int arg_col, int arg_row, int arg_idt, DataTable arg_dt, AxfpSpread arg_grid)
        {
            ...
            arg_grid.SetCellBorder(arg_col + 1, arg_row, arg_col + c, arg_row
                                      , CellBorderIndexConstants.CellBorderIndexLeft, 0x7789ff
                                      , CellBorderStyleConstants.CellBorderStyleSolid);
            arg_grid.SetCellBorder(arg_col + 1, arg_row, arg_col + c, arg_row
                                  , CellBorderIndexConstants.CellBorderIndexBottom, 0x7789ff
                                  , CellBorderStyleConstants.CellBorderStyleSolid);
        ...
        #region PH1
        private void DisplayGridPH1(DataTable arg_dt, AxfpSpread arg_grid)
        {
        ...
        private void MachineHeadPH1(int arg_icol, int arg_irow, int arg_idt, DataTable arg_dt, AxfpSpread arg_grid)
        {
            try
            {
                arg_grid.Col = arg_icol;
        ...
        public void MachineBodyPH1(int arg_icol, int arg_irow, int arg_idt, DataTable arg_dt, AxfpSpread arg_grid)
        {
            try
            {
                arg_grid.SetCellBorder(arg_icol + 1, arg_irow, arg_icol + 1, arg_irow, CellBorderIndexConstants.CellBorderIndexLeft, 0, CellBorderStyleConstants.CellBorderStyleSolid);
                arg_grid.SetCellBorder(arg_icol, arg_irow, arg_icol, arg_irow, CellBorderIndexConstants.CellBorderIndexLeft, 0, CellBorderStyleConstants.CellBorderStyleSolid);
                arg_grid.SetCellBorder(arg_icol, arg_irow, arg_icol, arg_irow, CellBorderIndexConstants.CellBorderIndexBottom, 0, CellBorderStyleConstants.CellBorderStyleSolid);
        ...
        private void SetModelPH1(int arg_icol, int arg_irow, string arg_text, AxfpSpread arg_grid)
        {
            if (arg_icol == 2)
                arg_grid.set_ColWidth(arg_icol, 4.0);
            else
...
//lblPH2.BackColor = Color.LightGray;
        ...
        //private void axGrid_Advance(object sender, Ax_DSpreadEvents_AdvanceEvent e)
        //{
        ...
        private void DisplayGridPH1(DataTable arg_dt, DataTable arg_dt2, AxfpSpread arg_grid)
        {
        ...
        private void MachineBodyPH1(int arg_icol, int arg_irow, int arg_irow1, int arg_idt, DataTable arg_dt, AxfpSpread arg_grid)
        {
            try
            {
                //arg_grid.SetCellBorder(arg_icol + 3, arg_irow, arg_icol + 5, arg_irow1, CellBorderIndexConstants.CellBorderIndexLeft, 0, CellBorderStyleConstants.CellBorderStyleSolid);
                arg_grid.SetCellBorder(arg_icol, arg_irow, arg_icol + 4, arg_irow1, CellBorderIndexConstants.CellBorderIndexLeft, 0, CellBorderStyleConstants.CellBorderStyleSolid);
                arg_grid.SetCellBorder(arg_icol, arg_irow, arg_icol + 3, arg_irow1, CellBorderIndexConstants.CellBorderIndexBottom, 0, CellBorderStyleConstants.CellBorderStyleSolid);
        ...
        private void MachineHeadPH11(int arg_icol, int arg_irow, int arg_idt, DataTable arg_dt, AxfpSpread arg_grid)
        {
            try
            { 
                arg_grid.Row = arg_irow;
