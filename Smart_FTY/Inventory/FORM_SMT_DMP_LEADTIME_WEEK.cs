...
namespace Smart_FTY
{
    public partial class FORM_SMT_DMP_LEADTIME_WEEK : Form
    {
        public FORM_SMT_DMP_LEADTIME_WEEK()
        {
            InitializeComponent();
        ...
        {
            Form fc = Application.OpenForms["FORM_LEADTIME_COMP_DMP"];
            if (fc != null)
            {
            ...
            {
                FORM_LEADTIME_COMP_DMP f = new FORM_LEADTIME_COMP_DMP();
                f.Show();
                this.Hide();
            }
        }
        ...
        {
            Form fc = Application.OpenForms["FORM_SMT_DMP_LEADTIME_MONTH"];
            if (fc != null)
            {
            ...
            {
                FORM_SMT_DMP_LEADTIME_MONTH f = new FORM_SMT_DMP_LEADTIME_MONTH();
                f.Show();
                this.Hide();
            }
        }
        ...
        {
            Form fc = Application.OpenForms["FORM_SMT_DMP_LEADTIME_YEAR"];
            if (fc != null)
            {
            ...
            {
                FORM_SMT_DMP_LEADTIME_YEAR f = new FORM_SMT_DMP_LEADTIME_YEAR();
                f.Show();
                this.Hide();
            }
        }
