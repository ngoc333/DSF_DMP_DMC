...
namespace Smart_FTY
{
    public partial class FORM_SMT_ROLL_PROD_YEAR : SampleFrm1
    {
        public FORM_SMT_ROLL_PROD_YEAR()
        {
            InitializeComponent();
           // formName = "FORM_SMT_ROLL_PROD_YEAR";
            this.Name = "FORM_SMT_ROLL_PROD_YEAR";
            this.Text = "FORM_SMT_ROLL_PROD_YEAR";
        }
        ...
        private void FORM_SMT_ROLL_PROD_YEAR_Load(object sender, EventArgs e)
        {
        ...
        public DataTable SEL_OS_PROD_YEAR(string ARG_QTYPE, string ARG_OP)
        {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_ROLL.SP_ROLL_PROD_YEAR";
        ...
        private void FORM_SMT_ROLL_PROD_YEAR_VisibleChanged(object sender, EventArgs e)
        {
