...
namespace Smart_FTY
{
    public partial class FRM_ROLL_SLABTEST_YEAR : SampleFrm1
    {
        public FRM_ROLL_SLABTEST_YEAR()
        {
            InitializeComponent();
        }
        ...
        public DataTable SEL_DATA_SLABTEST(string Qtype, string arg_op)
        {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_ROLL.SP_ROLL_SLABTEST_YEAR"; //SP_SMT_ANDON_DAILY
        ...
        private void BindingData(string arg_op)
        {
            ...
            if (dtsource != null && dtsource.Rows.Count > 0)
            {
                ...
                bandYear.Caption = dtsource.Rows[0]["YY"].ToString();
        ...
        {
            ComVar.Form_Type = "1";
            lblTitle.Text = "Rubber Slabtest Tracking by Year";
            BindingData("OS");
            bindingdatachart("OS");
            str_op = "OS";
            picimage.BackgroundImage = Image.FromFile(Application.StartupPath + @"\RUBBER.png");
            //picimage.BackgroundImage = global::Smart_FTY.Properties.Resources.rubber;
            //picimage.BackgroundImage = Image.FromFile(@"images\1.jpg");
        ...
        {
            ComVar.Form_Type = "2";
            lblTitle.Text = "EVA Slabtest Tracking by Year";
            BindingData("PH");
            bindingdatachart("PH");
            str_op = "PH";
            //picimage.BackgroundImage = global::Smart_FTY.Properties.Resources.eva;
            picimage.BackgroundImage = Image.FromFile(Application.StartupPath +  @"\EVA.png");
           // picimage.BackgroundImage = Image.FromFile("C:\\1.jpg");
