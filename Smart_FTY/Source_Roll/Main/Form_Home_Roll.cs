...
namespace Smart_FTY
{
    public partial class Form_Home_Roll : SampleFrm1 
    {
        ...
        private void setDataMachineryRubber(DataTable argDt)
        {
            try
            {
                UC_Rub1.setData(setArrRubber("Banbury 1", argDt, "BB102", "BANB"));
        ...
        private void setDataMachineryEva(DataTable argDt)
        {
                ...
                string[] arr7 = { "Kneader 1", argDt.Rows[0]["KNEADER_MC"].ToString(), "Green", argDt.Rows[0]["KNEADER_MAT"].ToString(), "Black" };
